        ...
        <form method="post" action="php/<?= isset($event) ? 'edit_billetterie.php?event_id='.$event_id : 'ajout_billetterie.php' ?>">
            ...
            <div class="general_infos">
                ...
                <div class="form-group">
                    ...
                    <input value="<?= isset($event['name']) ? htmlspecialchars($event['name']) : '' ?>" type="text" class="form-control" name="event_name" id="event_name" placeholder="Nom de l'évènement" autofocus required>
                </div>

                <div class="form-group">
                    <label for="event_description">Description de votre évènement :</label>
                    <textarea class="form-control" name="event_description" id="event_description" placeholder="Descrivez rapidement votre évènement" required><?= isset($event['description']) ? htmlspecialchars($event['description']) : '' ?></textarea>
                </div>
