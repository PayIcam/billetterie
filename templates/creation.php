			...
			<legend>Nouveau Shotgun</legend>
				...
				<div class="form-row col-md-12">
					<div id="div_date_debut" class="form-group col-sm-2">
						...
						<input id="date_debut" class="form-control" name="date_debut" type="datetime" title="JJ-MM-AAAA hh:mm:ss" value="<?php echo date("d-m-Y H:i:s");?>">
					</div>
					<div id="div_date_fin" class="form-group col-sm-2">
						<label>Date de fin</label>
						<input id="date_fin" type="datetime" class="form-control" name="date_fin" title="JJ-MM-AAAA hh:mm:ss" value="<?php $d=strtotime("tomorrow");
						echo date("d-m-Y H:i:s",$d); ?>">
					</div>
				</div>
				</div>
				<div id="div_nb_place" class="form-group col-sm-3">
				...
				<div class="form-row col-md-12" name="div_option" id="div_option">
					...
					<div class="form-group col-sm-2" id='div_place_option'>
					...
					<div name='input_js'>	<!-- inputs cachés pour stocker les valeurs des input générées par js, c'est moche mais pas moyen de les récupérer autrement -->
						<input type="hidden" value="" name="nb_place_option1">
						<input type="hidden" value="" name="nom_option2">
						<input type="hidden" value="" name="prix_option2">
						<input type="hidden" value="" name="nb_place_option2">
						<input type="hidden" value="" name="nom_option3">
						<input type="hidden" value="" name="prix_option3">
						<input type="hidden" value="" name="nb_place_option3">
						<input type="hidden" value="" name="nom_option4">
						<input type="hidden" value="" name="prix_option4">
						<input type="hidden" value="" name="nb_place_option4">
						<input type="hidden" value="" name="nom_option5">
						<input type="hidden" value="" name="prix_option5">
						<input type="hidden" value="" name="nb_place_option5">
						<input type="hidden" value="" name="nom_option6">
						<input type="hidden" value="" name="prix_option6">
						<input type="hidden" value="" name="nb_place_option6">
						<input type="hidden" value="" name="nom_option7">
						<input type="hidden" value="" name="prix_option7">
						<input type="hidden" value="" name="nb_place_option7">
						<input type="hidden" value="" name="nom_option8">
						<input type="hidden" value="" name="prix_option8">
						<input type="hidden" value="" name="nb_place_option8">
						<input type="hidden" value="" name="nom_option9">
						<input type="hidden" value="" name="prix_option9">
						<input type="hidden" value="" name="nb_place_option9">
						<input type="hidden" value="" name="nom_option10">
						<input type="hidden" value="" name="prix_option10">
						<input type="hidden" value="" name="nb_place_option10">
					</div>
				
				</div>
			</div>
			</fieldset>	
					<div class="form-group col-sm-2" id="div_bouton" name="div_bouton">
