...
/**
 * Fonction controlleur permettant à partir des ids d'évènements, de tester ceux qui devraient être affichés, et dans ce cas les afficher, et ne rien faire sinon
 * @param  [array] $events_id_accessible
 */
