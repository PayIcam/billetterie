...
CREATE TABLE IF NOT EXISTS `ticketing`.`participants` (
  ...
  `bracelet_identification` VARCHAR(25) NULL,
  `event_id` INT NOT NULL,
  `site_id` INT NOT NULL,
  `promo_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `ticketing`.`option_choices`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ticketing`.`option_choices` ;

CREATE TABLE IF NOT EXISTS `ticketing`.`option_choices` (
...
CREATE TABLE IF NOT EXISTS `ticketing`.`participant_has_options` (
  ...
  CONSTRAINT `fk_participant_has_options_option_choices1`
    ...
    REFERENCES `ticketing`.`option_choices` (`choice_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ticketing`.`config`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ticketing`.`config` ;

CREATE TABLE IF NOT EXISTS `ticketing`.`config` (
