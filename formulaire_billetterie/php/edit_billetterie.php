...
if(isset($_POST))
{
    ...
    delete_previous_option_accessibility(array("event_id" => $_POST['event_id']));
    delete_specification_details($_POST['event_id']);
    ...
    if(isset($_POST['option_details_json']))
    {
        ...
        $previous_options_ids = get_options_from_event($_POST['event_id']);
        ...
        if(count($options_precedentes_editees) < count($previous_options_ids))
        {
            foreach($previous_options_ids as $previous_options_id)
            {
                ...
                if($keep==0)
                {
                    delete_option(array("event_id" => $_POST['event_id'], "option_id" => $previous_option_id));
                }
            }
        }
    }
